...
public class Logic {
	...
	public static Notification editTask(ArrayList<Integer> taskIDs, ArrayList<Date> datetimes,String task, ArrayList<String> cats) {
		return new EditTask().editTask(taskIDs, datetimes, task, cats);
	}
